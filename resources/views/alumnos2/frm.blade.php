                ...
                <div class="card-body">
                    ...
                    action="@if ($accion == 'crear') 
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="noctrl" class="form-control" maxlength="8" id="noctrl"
                                value="{{ old('noctrl', $alumno->noctrl ?? '') }}" {{$desabilitado}}>
                            @error('noctrl')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nombre" class="form-control" id="nombre"
                                value="{{ old('nombre', $alumno->nombre) }}" aria-describedby="nombreHelp" {{$desabilitado}}>
                            @error('nombre')
                                <ul class="list-unstyled text-danger">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="apellidop" class="form-control" id="apellidop"
                                value="{{ old('apellidop', $alumno->apellidop) }}" aria-describedby="apellidoHelp" {{$desabilitado}}>
                            @error('apellidop')
                                <ul class="list-unstyled text-danger">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="apellidom" class="form-control" id="apellidom"
                                value="{{ old('apellidom', $alumno->apellidom ?? '') }}" {{$desabilitado}}>
                            @error('apellidom')
                                <ul class="list-unstyled text-danger">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" name="email" class="form-control" id="email"
                                value="{{ old('email', $alumno->email) }}" aria-describedby="emailHelp" {{$desabilitado}}>
                            @error('email')
                                <ul class="list-unstyled text-danger">
